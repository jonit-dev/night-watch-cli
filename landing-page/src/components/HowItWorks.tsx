...
const steps = [
  ...
  },
  {
    ...
    description: "The reviewer scores the PR, requests fixes, and retries. QA generates and runs e2e tests."
  },
  {
    number: "04",
    title: "You wake up to PRs",
    description: "Review, approve, merge. Or let auto-merge handle it when the score is high enough."
  }
];
    ...
    <section id="how-it-works" className="py-24 px-4">
      <div className="container mx-auto max-w-5xl">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">From spec to merged PR — while you sleep</h2>
          <p className="text-gray-400 max-w-2xl mx-auto">A fully autonomous pipeline that respects your workflow.</p>
        </div>

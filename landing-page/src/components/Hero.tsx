  ...
  return (
    <section className="pt-24 pb-20 px-4 relative min-h-[100svh] flex flex-col justify-center">
      <div className="container mx-auto max-w-5xl text-center relative z-10">
        ...
        >
          Your repo's{' '}
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 via-purple-400 to-indigo-500 drop-shadow-[0_0_30px_rgba(99,102,241,0.3)]">
            night shift.
          </span>
        </motion.h1>
        ...
        >
          ...
          reviewed code, and tested features.
        </motion.p>
        ...
        >
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="px-6 py-3 rounded-xl font-medium text-white border border-white/10 bg-white/5 hover:bg-white/10 backdrop-blur-md transition-all w-full sm:w-auto"
          >
            Read the docs
          </a>
        </motion.div>
      ...
      >
        ...
        <a
          href="#features"
          className="w-6 h-10 rounded-full border-2 border-gray-700 flex justify-center p-1 hover:border-indigo-500 transition-colors"
        >
          <motion.div
            animate={{ y: [0, 12, 0] }}

    ...
    <header className="sticky top-0 z-50 w-full border-b border-white/5 bg-gray-950/80 backdrop-blur-md">
      <div className="container mx-auto px-4 h-16 flex items-center justify-between">
        <a href="#" className="flex items-center gap-3 group">
          ...
          <span className="font-extrabold text-xl tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-white to-gray-400 group-hover:to-gray-300 transition-colors">
            Night Watch
          </span>
        </a>
        ...
        <div className="md:hidden border-t border-white/5 bg-gray-950/95 backdrop-blur-xl absolute w-full">
          <nav className="flex flex-col p-4 gap-4 text-sm font-medium text-gray-400">
            ...
            <a
              href="#quick-start"
              onClick={() => setIsOpen(false)}
              className="bg-indigo-600 hover:bg-indigo-500 text-white px-4 py-3 rounded-md text-center mt-2 transition-colors"
            >
              Get Started
            </a>
          </nav>

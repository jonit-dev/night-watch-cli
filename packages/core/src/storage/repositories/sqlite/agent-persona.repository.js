 ...
 */
const GITHUB_RAW_BASE = 'https://raw.githubusercontent.com/jonit-dev/night-watch-cli/main/web/public/avatars';
...
let SqliteAgentPersonaRepository = class SqliteAgentPersonaRepository {
    _db;
    constructor(db) {
        this._db = db;
    }
    ...
    patchDefaultAvatarUrls() {
        for (const [name, url] of Object.entries(DEFAULT_AVATAR_URLS)) {
            this._db
                .prepare(`UPDATE agent_personas SET avatar_url = ?, updated_at = ?
...
export { SqliteAgentPersonaRepository };

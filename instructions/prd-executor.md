...
When this skill activates: `PRD Executor: Initializing`

---

## Input

The user provides a path to a PRD file (e.g., `docs/PRDs/my-feature.md`).

If no path is given, ask for it.
...
5. Run yarn verify and fix any issues
...
- **Verify always** - never skip yarn verify between waves
